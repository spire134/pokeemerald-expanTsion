...
const struct TrainerClass gTrainerClasses[TRAINER_CLASS_COUNT] =
{
    ...
    [TRAINER_CLASS_LEADER] = { _("Captain"), 25, BALL_GREAT },
    ...
    [TRAINER_CLASS_DOME_ACE] = { _("Hive Knight"), 15, BALL_ULTRA },
    [TRAINER_CLASS_PALACE_MAVEN] = { _("Hive Maven"), 25, BALL_DUSK },
    [TRAINER_CLASS_ARENA_TYCOON] = { _("Arena Tycoon") },
    [TRAINER_CLASS_FACTORY_HEAD] = { _("Factory Head") },
    [TRAINER_CLASS_PIKE_QUEEN] = { _("Pike Queen") },
    [TRAINER_CLASS_PYRAMID_KING] = { _("Pyramid King") },
    [TRAINER_CLASS_RS_PROTAG] = { _("{PKMN} Trainer") },
    [TRAINER_CLASS_HIVE] = { _("Hive"), 2, BALL_NET },
    [TRAINER_CLASS_PIRATE] = { _("Pirate"), 8, BALL_DIVE },
    [TRAINER_CLASS_DP_ACE_TRAINER_DUO] = { _("Ace Trainer Duo"), 10, BALL_ULTRA },
    [TRAINER_CLASS_DP_ACE_TRAINER_F] = { _("Ace Trainer♀"), 10, BALL_ULTRA },
    [TRAINER_CLASS_DP_ACE_TRAINER_M] = { _("Ace Trainer♂"), 10, BALL_ULTRA },
    [TRAINER_CLASS_DP_ACE_TRAINER_SNOW_F] = { _("Ace Trainer Snow♀"), 10, BALL_ULTRA },
    [TRAINER_CLASS_DP_ACE_TRAINER_SNOW_M] = { _("Ace Trainer Snow♂"), 10, BALL_ULTRA },
    [TRAINER_CLASS_DP_CAMERAMAN] = { _("Cameraman"), 10, BALL_POKE },
    [TRAINER_CLASS_DP_CLOWN] = { _("Clown"), 10, BALL_REPEAT },
    [TRAINER_CLASS_DP_COWGIRL] = { _("Cowgirl"), 10, BALL_POKE },
    [TRAINER_CLASS_DP_CYCLIST_F] = { _("Cyclist♀"), 10, BALL_POKE },
    [TRAINER_CLASS_DP_CYCLIST_M] = { _("Cyclist♂"), 10, BALL_POKE },
    [TRAINER_CLASS_DP_GALACTIC_GRUNT_F] = { _("Galactic Grunt♀"), 10, BALL_POKE },
    [TRAINER_CLASS_DP_GALACTIC_GRUNT_M] = { _("Galactic Grunt♂"), 10, BALL_POKE },
    [TRAINER_CLASS_DP_GALACTIC_GRUNT_DUO_MM] = { _("Galactic Grunt Duo"), 10, BALL_POKE },
    [TRAINER_CLASS_DP_GAMBLER] = { _("Gambler"), 10, BALL_POKE },
    [TRAINER_CLASS_DP_IDOL] = { _("Idol"), 10, BALL_LOVE },
    [TRAINER_CLASS_DP_JOGGER] = { _("Jogger"), 3, BALL_POKE },
    [TRAINER_CLASS_DP_JUPITER] = { _("Jupiter"), 10, BALL_POKE },
    [TRAINER_CLASS_DP_OFFICER] = { _("Officer"), 5, BALL_POKE },
    [TRAINER_CLASS_DP_PAINTER] = { _("Painter"), 2, BALL_POKE },
    [TRAINER_CLASS_DP_POKE_KID] = { _("Poke Kid"), 2, BALL_POKE },
    [TRAINER_CLASS_DP_RANCHER] = { _("Rancher"), 3, BALL_NEST },
    [TRAINER_CLASS_DP_RANCHER_DUO] = { _("Rancher Duo"), 4, BALL_NEST },
    [TRAINER_CLASS_DP_REPORTER] = { _("Reporter"), 5, BALL_TIMER },
    [TRAINER_CLASS_DP_ROARK] = { _("Roark"), 10, BALL_POKE },
    [TRAINER_CLASS_DP_ROCKER] = { _("Rocker"), 6, BALL_POKE },
    [TRAINER_CLASS_DP_ROUGHNECK] = { _("Roughneck"), 7, BALL_POKE },
    [TRAINER_CLASS_DP_SCIENTIST] = { _("Scientist"), 8, BALL_REPEAT },
    [TRAINER_CLASS_DP_SKIER_F] = { _("Skier♀"), 10, BALL_GREAT },
    [TRAINER_CLASS_DP_SKIER_M] = { _("Skier♂"), 10, BALL_GREAT },
    [TRAINER_CLASS_DP_SOCIALITE] = { _("Socialite"), 15, BALL_PREMIER },
    [TRAINER_CLASS_DP_VETERAN] = { _("Veteran"), 12, BALL_POKE },
    [TRAINER_CLASS_DP_WAITER] = { _("Waiter"), 8, BALL_POKE },
    [TRAINER_CLASS_DP_WAITRESS] = { _("Waitress"), 8, BALL_POKE },
    [TRAINER_CLASS_DP_WORKER] = { _("Worker"), 6, BALL_POKE },
};
