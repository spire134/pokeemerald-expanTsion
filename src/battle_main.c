...
const struct TrainerClass gTrainerClasses[TRAINER_CLASS_COUNT] =
{
    ...
    [TRAINER_CLASS_DP_ACE_TRAINER_DUO] = { _("Ace Trainers"), 10, BALL_ULTRA },
    [TRAINER_CLASS_DP_ACE_TRAINER_F] = { _("Ace Trainer"), 10, BALL_ULTRA },
    [TRAINER_CLASS_DP_ACE_TRAINER_M] = { _("Ace Trainer"), 10, BALL_ULTRA },
    [TRAINER_CLASS_DP_ACE_TRAINER_SNOW_F] = { _("Ace Trainer"), 10, BALL_ULTRA },
    [TRAINER_CLASS_DP_ACE_TRAINER_SNOW_M] = { _("Ace Trainer"), 10, BALL_ULTRA },
    ...
    [TRAINER_CLASS_DP_GALACTIC_GRUNT_F] = { _("Moonman"), 10, BALL_POKE },
    [TRAINER_CLASS_DP_GALACTIC_GRUNT_M] = { _("Moonwoman"), 10, BALL_POKE },
    [TRAINER_CLASS_DP_GALACTIC_GRUNT_DUO_MM] = { _("Moon Duo"), 10, BALL_POKE },
