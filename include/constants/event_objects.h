...
#define OBJ_EVENT_PAL_DP_AARON                    0x1201
#define OBJ_EVENT_PAL_DP_ACE_TRAINER              0x1202
#define OBJ_EVENT_PAL_DP_ACE_TRAINER_SNOWM        0x1203
#define OBJ_EVENT_PAL_DP_BARRY                    0x1204
#define OBJ_EVENT_PAL_DP_BATTLE_GIRL              0x1205
#define OBJ_EVENT_PAL_DP_BEAUTY                   0x1206
#define OBJ_EVENT_PAL_DP_BERTHA                   0x1207
#define OBJ_EVENT_PAL_DP_BLACK_BELT               0x1208
#define OBJ_EVENT_PAL_DP_BREEDERF                 0x1209
#define OBJ_EVENT_PAL_DP_BUG_CATCHER              0x120A
#define OBJ_EVENT_PAL_DP_BYRON                    0x120B
#define OBJ_EVENT_PAL_DP_CAMPER_PICNICKER         0x120C
#define OBJ_EVENT_PAL_DP_CHARON                   0x120D
#define OBJ_EVENT_PAL_DP_CHERYL                   0x120E
#define OBJ_EVENT_PAL_DP_COWGIRL                  0x120F
#define OBJ_EVENT_PAL_DP_CRASHER_WAKE             0x1210
#define OBJ_EVENT_PAL_DP_CYRUS                    0x1211
#define OBJ_EVENT_PAL_DP_DRAGON_TAMER             0x1212
#define OBJ_EVENT_PAL_DP_FANTINA                  0x1213
#define OBJ_EVENT_PAL_DP_FISHERMAN                0x1214
#define OBJ_EVENT_PAL_DP_GALACTIC_GRUNTF          0x1215
#define OBJ_EVENT_PAL_DP_GALACTIC_GRUNTM          0x1216
#define OBJ_EVENT_PAL_DP_GENTLEMAN                0x1217
#define OBJ_EVENT_PAL_DP_HIKER                    0x1218
#define OBJ_EVENT_PAL_DP_JUPITER                  0x1219
#define OBJ_EVENT_PAL_DP_LADY                     0x121A
#define OBJ_EVENT_PAL_DP_LOOKER                   0x121B
#define OBJ_EVENT_PAL_DP_LUCIAN                   0x121C
#define OBJ_EVENT_PAL_DP_MARLEY                   0x121D
#define OBJ_EVENT_PAL_DP_MARS                     0x121E
#define OBJ_EVENT_PAL_DP_MAYLENE                  0x121F
#define OBJ_EVENT_PAL_DP_MIRA                     0x1220
#define OBJ_EVENT_PAL_DP_OFFICER                  0x1221
#define OBJ_EVENT_PAL_DP_PAINTER                  0x1222
#define OBJ_EVENT_PAL_DP_PALMER                   0x1223
#define OBJ_EVENT_PAL_DP_PARASOL_LADY             0x1224
#define OBJ_EVENT_PAL_DP_POKE_KID                 0x1225
#define OBJ_EVENT_PAL_DP_POKE_RANGER              0x1226
#define OBJ_EVENT_PAL_DP_POKE_FANF                0x1227
#define OBJ_EVENT_PAL_DP_POKE_FANM                0x1228
#define OBJ_EVENT_PAL_DP_ROWAN                    0x1229
#define OBJ_EVENT_PAL_DP_PSYCHIC                  0x122A
#define OBJ_EVENT_PAL_DP_RANCHER                  0x122B
#define OBJ_EVENT_PAL_DP_RICH_BOY                 0x122C
#define OBJ_EVENT_PAL_DP_RICH_LADY                0x122D
#define OBJ_EVENT_PAL_DP_ROCKER                   0x122E
#define OBJ_EVENT_PAL_DP_ROUGHNECK                0x122F
#define OBJ_EVENT_PAL_DP_RUIN_MANIAC              0x1230
#define OBJ_EVENT_PAL_DP_SAILOR                   0x1231
#define OBJ_EVENT_PAL_DP_SATURN                   0x1232
#define OBJ_EVENT_PAL_DP_SCIENTIST                0x1233
#define OBJ_EVENT_PAL_DP_SKIERF                   0x1234
#define OBJ_EVENT_PAL_DP_SKIERM                   0x1235
#define OBJ_EVENT_PAL_DP_SOCIALITE                0x1236
#define OBJ_EVENT_PAL_DP_SUPERNERD                0x1237
#define OBJ_EVENT_PAL_DP_SWIMMERF                 0x1238
#define OBJ_EVENT_PAL_DP_SWIMMERF2                0x1239
#define OBJ_EVENT_PAL_DP_SWIMMERM                 0x123A
#define OBJ_EVENT_PAL_DP_VOLKNER                  0x123B
#define OBJ_EVENT_PAL_DP_WAITER                   0x123C
#define OBJ_EVENT_PAL_DP_WAITRESS                 0x123D
#define OBJ_EVENT_PAL_DP_WORKER                   0x123E
#define OBJ_EVENT_PAL_DP_YOUNG_COUPLE             0x123F
#define OBJ_EVENT_PAL_DP_YOUNGSTER                0x1240
