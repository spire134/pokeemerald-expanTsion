...
#define VAR_HEART_SCALES_GIVEN_TO_DOLL                   0x40F7 // Unused Var
#define VAR_MANSION_PROGRESSION                          0x40F8 // Unused Var
#define VAR_PIRATE_QUEST_PROGRESSION                     0x40F9 // Unused Var
