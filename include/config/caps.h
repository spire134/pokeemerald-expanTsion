...
// Level Cap Configs
#define B_EXP_CAP_TYPE                  1   // [EXP_CAP_NONE, EXP_CAP_HARD, EXP_CAP_SOFT] choose the type of level cap to apply
...
// EV Cap Configs
#define B_EV_CAP_TYPE                   EV_CAP_FLAG_LIST  // [EV_CAP_NONE, EV_CAP_FLAG_LIST, EV_CAP_VARIABLE, EV_CAP_NO_GAIN] choose the type of EV cap to apply
#define B_EV_CAP_VARIABLE               0                 // event variable used to derive EV cap if B_EV_CAP_TYPE is set to EV_CAP_VARIABLE
